...
namespace Generate_Random_Password
{
    class EightSpecialLetterPass
    {
        ...
        public void GenPass()
        {
            ...
            Console.WriteLine(upperCaseAlphabet[indexUpper1] + lowerCaseAlphabet[indexLower1] + specialCharacters[indexSpecial1] + numbers[indexNumber1] + upperCaseAlphabet[indexUpper2] + lowerCaseAlphabet[indexLower2] + specialCharacters[indexSpecial2] + numbers[indexNumber2]);
