...
namespace Generate_Random_Password
{
    class EightLetterPass
    {
        ...
        public void GenPass()
        {
            ...
            Console.WriteLine(upperCaseAlphabet[indexUpper1] + lowerCaseAlphabet[indexLower1] + lowerCaseAlphabet[indexLower2] + lowerCaseAlphabet[indexLower3] + lowerCaseAlphabet[indexLower4] + lowerCaseAlphabet[indexLower5] + lowerCaseAlphabet[indexLower6] + upperCaseAlphabet[indexUpper2]);
        }
